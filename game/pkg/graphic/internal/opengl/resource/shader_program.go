...
func UniformTransform(sp gresource.ShaderProgram, variable string, transform math.Transform) error {
	return UniformMat4(sp, variable, mgl32.Mat4(transform))
}

func getUniformLocation(sp gresource.ShaderProgram, variable string) int32 {
...
func BuildShaderProgram(_ context.Context, builder ShaderProgramBuilder) (gresource.ShaderProgram, error) {
	...
	return gresource.ShaderProgram(shaderProgram), nil
}
